  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        <h2 className="font-heading font-bold text-4xl md:text-5xl text-foreground mb-6">Ready to launch?</h2>
        <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto">
          Experience the future of marine decision-intelligence. Access real-time data, fused and validated by ORCA.
        </p>
